<script type="text/javascript">
	$(document).ready(function(){
			...
			$('#KodeDiklat').change(function(e) {
				...
				pageload('cpanitiadiklat/listpanitiadiklat/'+kodediklat,'#table');
            });
	...
	$('#edit').click(function(){
		...
		var kodediklat = $('#KodeDiklat').val();
		$('#popuphead').html("<font size='4'> <b>Daftar Pegawai</font></b>");
		pageload('cpanitiadiklat/totalpegawai/'+kodediklat,'#popupfoot');
		pageload('cpanitiadiklat/listpegawai/'+kodediklat,'#popup');
...
<tr>
        ...
        <td><?php $this->mdiklat->combodiklatpanitia('KodeDiklat'); ?></td>
    </tr>    
     <tr>
    	<td align="right"></td>
        <td><input type="button" name="edit" id="edit" value="Tambah/Hapus Panitia Diklat" /></td>
    </tr>
</table>
</form>
</td></tr></table>