...
<ul id="nav">
   ...
   <li class="top"><a href="javascript:void(0)" id="Admin" class="top_link"><span class="down">[ <?php echo $this->session->userdata('level')." ". $this->mdiklat->detailunitkerja($this->session->userdata('unitkerja')); ?> ]</span></a>
   		<ul class="sub">
