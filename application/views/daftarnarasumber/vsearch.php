<script type="text/javascript">
	...
	function cariDataUtama(){
            send_form_loading(document.frmcariutama,'cdaftarnarasumber/listnarasumber/0/20','#table');
	}
	...
	$('#addnewdata').click(function(e) {
		...
		$('#table').fadeOut();
		$('#search').fadeOut();
		$('#headform').html('Input Data Narasumber');
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <?php if($this->session->userdata('diklat')==1){ ?>
            <input type="button" id="addnewdata" name="addnewdata" value="Tambah Data Narasumber">
         <?php } ?> 
         </td>
